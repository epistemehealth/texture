...
function _exportElementCitation (node, exporter) {
  ...
  let refdate = new Date(node.accessedDate)
  let isodate = refdate.toISOString().substring(0,10)
  el.append(_createTextElement($$, node.accessedDate, 'date-in-citation', { 'iso-8601-date': isodate }))
